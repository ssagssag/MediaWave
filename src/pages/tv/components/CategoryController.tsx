...
import airingToday from "../../../assets/categoryController/nowplaying.svg";
import ontheAir from "../../../assets/categoryController/upcoming.svg";
...
export default function CategoryController({ scrollToCategory }: CategoryControllerProps) {
  const svgs = [popular, toprated, airingToday, ontheAir, trending, lastYear, shortRuntime, recommend];
